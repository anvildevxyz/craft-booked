 ...
 * refund action is gated by `booked-manageRefunds` and delegates to the refund
...
{
    private const CONTROLLER = 'anvildev\booked\controllers\cp\BookingsController';
    ...
    public function testRefundActionRequiresManageRefundsPermission(): void
    {
        ...
        $this->assertStringContainsString("requirePermission('booked-manageRefunds')", $src);
    ...
    public function testRefundActionDelegatesToPaymentServiceAndTranslatesGuardErrors(): void
    {
        ...
        $this->assertStringContainsString("Craft::t('booked', \$e->getMessage())", $src);
    }
