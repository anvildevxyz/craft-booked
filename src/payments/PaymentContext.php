...
namespace anvildev\booked\payments;

/**
 * Immutable input to {@see \anvildev\booked\contracts\PaymentGatewayInterface::createPayment()}.
 * The amount is server-computed (service + extras + policy) in **minor units**
