 ...
 * `@typedef {import('./types.js').ServiceExtra} ServiceExtra`. The API shapes
 * are the contract emitted by the plugin's `/booked/api/v1` controllers.
 */
 ...
 * @property {string} durationType     'minutes' | 'days' | 'flexible_days'
 * @property {string} [pricingMode]    'flat' | 'per_unit'
 */

/**
 * @typedef {Object} ServiceExtra
 * @property {number} id
 ...
 * @property {string} formattedTimeRange
 * @property {number} remainingCapacity
 * @property {boolean} isFullyBooked
 * @property {number} price
 */
 ...
 * @property {string} [conversionToken]    waitlist-conversion prefill (book mode)
 ...
 * @property {import('./api.js').BookedApi} [apiClient]  inject an API client (tests)
 */

/** A per-step content renderer. @typedef {{ mount?: Function, render: Function, unmount?: Function }} StepRenderer */

/** Discriminated `data:loaded` payload; `items` is the list for `kind`. @typedef {{ kind: string, items: any, waitlistAvailable?: boolean }} DataLoadedPayload */
